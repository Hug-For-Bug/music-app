...
<!-- Mirrored from xvelopers.com/demos/html/rekord/albums.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 05 Jan 2023 11:24:36 GMT -->
...
<body class="sidebar-mini sidebar-collapse theme-dark  sidebar-expanded-on-hover has-preloader" style="display: none;">
 ...
 -->
                    ...
                    <li class="menu-item-has-children">
                        ...
                        <ul class="sub-menu">
                            ...
                            <li><a href="element-tabs.html"><i class="icon icon-folder text-primary s-14"></i>
                                    <span>Tabs</span></a></li>
                            <li><a href="element-progress-bars.html"><i
                                        class="icon icon-battery-5 text-primary s-14"></i>
                                    <span>Progress Bars</span></a></li>

                            <li><a href="element-preloaders.html"><i
                                        class="icon icon-attachment text-primary s-14"></i>
                ...
                <div class="navbar-custom-menu">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="searchOverlay-wrap">
                            <a href="#" id="btn-searchOverlay"
                                class="nav-link mr-3 btn--searchOverlay no-ajaxy">
                    ...
                    <div class="animated fadeInUpShort p-5 ml-lg-5 mr-lg-5">
                        <section>
                            <div class="relative my-5">
                                ...
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. <br>Architecto atque aut
                                    blanditiis
                                    consectetur</p>
                            </div>
                            <div class="wrapper">
    ...
    <!--/#rekord-app -->
    <script
        src="../../../../maps.googleapis.com/maps/api/js0e31?&amp;key=AIzaSyC3YkZNNySdyR87o83QEHWglHfHD_PZqiw&amp;libraries=places">
    </script>
