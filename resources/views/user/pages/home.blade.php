    ...
    <div class="wrapper p-md-5 p-3  ">
                                    ...
                                    <ul class="list-inline d-flex align-items-center justify-content-between">
                                        <li class="list-inline-item">
                                            <a href="#" class="snackbar" data-text="Added to favourites"
                                                ...
                                                data-actionTextColor="#fff" data-backgroundColor="#0c101b">
                                        ...
                                        <li class="list-inline-item">
                                            <a href="album-single.html"><i class="icon-more s-18 pt-3"></i></a>
                                        </li>
                                    </ul>
        ...
        <section class="section">
            ...
            <div class="lightSlider has-items-overlay" data-item="3" data-item-lg="2" data-item-md="1"
                data-item-sm="1" data-auto="false" data-pager="false" data-controls="true" data-loop="false">
                <div class="card">
                                        ...
                                        <div>
                                            ...
                                            <div class="mt-3">
                                                <ul class="nav nav-tabs card-header-tabs nav-material responsive-tab mb-1"
                                                    role="tablist">
                                                    <li class="nav-item">
                                                        <a class="nav-link active show" id="w2--tab1" data-toggle="tab"
                                                            href="#w2-tab1" role="tab" aria-selected="true">Rock</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" id="w3--tab1" data-toggle="tab"
                                                            href="#w2-tab1" role="tab" aria-selected="false">Jazz</a>
                                                    </li>
                                                    <li class="nav-item">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="col-md-5 d-none d-lg-block">
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="ml-auto">
                                                            <a href="#" class="btn btn-outline-primary btn-sm">Buy
                                                                at iTunes</a>
                                                        </div>
                                                    </div>
                                                </div>
