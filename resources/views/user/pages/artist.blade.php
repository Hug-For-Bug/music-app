...
@section('content')
    <div class="wrapper animated fadeInUpShort p-5 ml-lg-5 mr-lg-5">
        ...
        <div class="lightSlider mb-5" data-pager="false" data-item="26" data-item-lg="13" data-item-md="13" data-item-sm="6">
            <div><a href="#" class="btn btn-outline-primary btn btn-sm r-5">A</a></div>
            <div><a href="#" class="btn btn-outline-primary btn btn-sm r-5">B</a></div>
            <div><a href="#" class="btn btn-outline-primary btn btn-sm r-5">C</a></div>
            <div><a href="#" class="btn btn-outline-primary btn btn-sm r-5">D</a></div>
            <div><a href="#" class="btn btn-outline-primary btn btn-sm r-5">E</a></div>
            <div><a href="#" class="btn btn-outline-primary btn btn-sm r-5">F</a></div>
        ...
        <div class="avatar avatar-md avatar-letter-a mb-5 primary-color"></div>
        <div class="row mb-5">
        ...
        <div class="avatar avatar-md avatar-letter-b mb-5 primary-color"></div>
        <div class="row mb-5">
        ...
        <div class="avatar avatar-md avatar-letter-c mb-5 primary-color"></div>
        <div class="row mb-5">
        ...
        <div class="avatar avatar-md avatar-letter-d mb-5 primary-color"></div>
        <div class="row mb-5">
